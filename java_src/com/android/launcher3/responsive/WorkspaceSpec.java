...
public final class WorkspaceSpec extends ResponsiveSpec {
    ...
    */
    public WorkspaceSpec(android.content.res.TypedArray r12, java.util.Map r13) {
        /*
            r11 = this;
        ...
        L54:
            ...
            java.lang.String r12 = "Invalid WorkspaceSpec found."
            java.lang.String r12 = r12.toString()
            r11.<init>(r12)
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.launcher3.responsive.WorkspaceSpec.<init>(android.content.res.TypedArray, java.util.Map):void");
    }
    ...
    public final boolean isValid() {
        if (this.startPadding.getMatchWorkspace() || this.endPadding.getMatchWorkspace() || this.gutter.getMatchWorkspace() || this.cellSize.getMatchWorkspace()) {
            Log.e("WorkspaceSpecs", "WorkspaceSpec#isValid - workspace shouldn't contain matchWorkspace!");
            return false;
        }
