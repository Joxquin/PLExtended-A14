...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, LV1/l;->a:Landroid/content/Context;
...
# virtual methods
.method public final a(LV1/f;Landroid/content/IntentFilter;)V
    .locals 3
    ...
    iget-object v1, p0, LV1/l;->a:Landroid/content/Context;

    invoke-direct {p2, v1}, Landroid/app/prediction/AppPredictionContext$Builder;-><init>(Landroid/content/Context;)V

    const-string v2, "share"

    invoke-virtual {p2, v2}, Landroid/app/prediction/AppPredictionContext$Builder;->setUiSurface(Ljava/lang/String;)Landroid/app/prediction/AppPredictionContext$Builder;

    move-result-object p2

    const/4 v2, 0x4

    invoke-virtual {p2, v2}, Landroid/app/prediction/AppPredictionContext$Builder;->setPredictedTargetCount(I)Landroid/app/prediction/AppPredictionContext$Builder;
    ...
    iput-object p2, p0, LV1/l;->b:Landroid/app/prediction/AppPredictor;

    iput-object p1, p0, LV1/l;->c:Landroid/app/prediction/AppPredictor$Callback;
    ...
    iget-object p0, p0, LV1/l;->b:Landroid/app/prediction/AppPredictor;
...
.method public final b(Landroid/app/prediction/AppTarget;)V
    .locals 7

    if-eqz p1, :cond_0

    iget-object v0, p0, LV1/l;->b:Landroid/app/prediction/AppPredictor;
...
.method public final c()V
    ...
    iget-object v1, p0, LV1/l;->c:Landroid/app/prediction/AppPredictor$Callback;
    ...
    iput-object v2, p0, LV1/l;->c:Landroid/app/prediction/AppPredictor$Callback;
    ...
    iput-object v2, p0, LV1/l;->b:Landroid/app/prediction/AppPredictor;
