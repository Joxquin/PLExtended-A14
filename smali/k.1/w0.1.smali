...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lk/w0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Lk/w0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iput-boolean v0, p0, Lk/w0;->d:Z

    const/4 v1, -0x1

    .line 5
    iput v1, p0, Lk/w0;->e:I

    const/4 v2, 0x0

    .line 6
    iput v2, p0, Lk/w0;->f:I

    const v3, 0x800033

    .line 7
    iput v3, p0, Lk/w0;->h:I
    ...
    .line 11
    invoke-static/range {v4 .. v10}, Landroidx/core/view/H;->b(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    .line 30
    invoke-static {p3, p1}, Lf/a;->a(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 32
    :goto_0
    iget-object p2, p0, Lk/w0;->n:Landroid/graphics/drawable/Drawable;
    ...
    .line 33
    :cond_6
    iput-object p1, p0, Lk/w0;->n:Landroid/graphics/drawable/Drawable;
    ...
    iput p2, p0, Lk/w0;->p:I

    goto :goto_1

    .line 36
    :cond_7
    iput v2, p0, Lk/w0;->o:I

    .line 37
    iput v2, p0, Lk/w0;->p:I
...
.method public checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of p0, p1, Lk/v0;

    return p0
.end method

.method final e(ILandroid/graphics/Canvas;)V
    .locals 4

    iget-object v0, p0, Lk/w0;->n:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getPaddingLeft()I

    move-result v1

    iget v2, p0, Lk/w0;->r:I
    ...
    iget v3, p0, Lk/w0;->r:I

    sub-int/2addr v2, v3

    iget v3, p0, Lk/w0;->p:I

    add-int/2addr v3, p1

    invoke-virtual {v0, v1, p1, v2, v3}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object p0, p0, Lk/w0;->n:Landroid/graphics/drawable/Drawable;
...
.method final f(ILandroid/graphics/Canvas;)V
    .locals 5
...
.method public g()Lk/v0;
    .locals 1

    iget p0, p0, Lk/w0;->g:I

    if-nez p0, :cond_0

    new-instance p0, Lk/v0;
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Lk/w0;->g()Lk/v0;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lk/w0;->h(Landroid/util/AttributeSet;)Lk/v0;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lk/w0;->i(Landroid/view/ViewGroup$LayoutParams;)Lk/v0;
...
.method public final getBaseline()I
    ...
    :cond_2
    iget v2, p0, Lk/w0;->f:I

    iget v3, p0, Lk/w0;->g:I

    const/4 v4, 0x1

    if-ne v3, v4, :cond_5

    iget v3, p0, Lk/w0;->h:I
...
.method public h(Landroid/util/AttributeSet;)Lk/v0;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lk/v0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public i(Landroid/view/ViewGroup$LayoutParams;)Lk/v0;
    .locals 0
    ...
    invoke-direct {p0, p1}, Lk/v0;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, v2}, Lk/w0;->j(I)Z
    ...
    iget v4, p0, Lk/w0;->p:I

    sub-int/2addr v3, v4

    invoke-virtual {p0, v3, p1}, Lk/w0;->e(ILandroid/graphics/Canvas;)V
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lk/w0;->j(I)Z
    ...
    :goto_1
    invoke-virtual {p0, v0, p1}, Lk/w0;->e(ILandroid/graphics/Canvas;)V
    ...
    iget v5, p0, Lk/w0;->o:I

    sub-int/2addr v4, v5

    :goto_3
    invoke-virtual {p0, v4, p1}, Lk/w0;->f(ILandroid/graphics/Canvas;)V
    ...
    :goto_5
    invoke-virtual {p0, v0, p1}, Lk/w0;->f(ILandroid/graphics/Canvas;)V
...
.method public onLayout(ZIIII)V
    ...
    :cond_3
    sget-object v17, Landroidx/core/view/J;->a:Ljava/util/WeakHashMap;
    ...
    :goto_3
    invoke-virtual {v0, v3}, Lk/w0;->j(I)Z

    move-result v8

    if-eqz v8, :cond_6

    iget v8, v0, Lk/w0;->p:I
    ...
    iget v10, v0, Lk/w0;->h:I

    and-int/2addr v6, v10

    and-int/lit8 v10, v10, 0x70

    iget-boolean v11, v0, Lk/w0;->d:Z

    iget-object v12, v0, Lk/w0;->l:[I

    iget-object v13, v0, Lk/w0;->m:[I
    ...
    :cond_14
    :goto_a
    invoke-virtual {v0, v9}, Lk/w0;->j(I)Z

    move-result v8

    if-eqz v8, :cond_15

    iget v8, v0, Lk/w0;->o:I
...
.method public onMeasure(II)V
    ...
    iget v0, v6, Lk/w0;->e:I

    iget-boolean v9, v6, Lk/w0;->k:Z
    ...
    iget v4, v6, Lk/w0;->i:I

    add-int/2addr v4, v5

    iput v4, v6, Lk/w0;->i:I
    ...
    :cond_1
    invoke-virtual {v6, v13}, Lk/w0;->j(I)Z
    ...
    invoke-virtual {v6, v10}, Lk/w0;->j(I)Z
    ...
    iget v12, v6, Lk/w0;->i:I

    add-int/2addr v12, v4

    iput v12, v6, Lk/w0;->i:I
    ...
    iget-object v0, v6, Lk/w0;->l:[I

    const/4 v12, 0x4

    if-eqz v0, :cond_2a

    iget-object v0, v6, Lk/w0;->m:[I
    ...
    iput-object v0, v6, Lk/w0;->l:[I

    new-array v0, v12, [I

    iput-object v0, v6, Lk/w0;->m:[I

    :cond_2b
    iget-object v13, v6, Lk/w0;->l:[I

    iget-object v14, v6, Lk/w0;->m:[I
    ...
    iget-boolean v5, v6, Lk/w0;->d:Z

    iget-boolean v4, v6, Lk/w0;->k:Z
    ...
    iget v8, v6, Lk/w0;->i:I

    const/16 v25, 0x0

    add-int/lit8 v8, v8, 0x0

    iput v8, v6, Lk/w0;->i:I
    ...
    :cond_2e
    invoke-virtual {v6, v3}, Lk/w0;->j(I)Z
    ...
    invoke-virtual {v6, v9}, Lk/w0;->j(I)Z
