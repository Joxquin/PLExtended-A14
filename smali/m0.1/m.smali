...
.method public constructor <init>(Lr0/h;)V
    ...
    iput-object v0, p0, Lm0/m;->c:Landroid/graphics/Path;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lm0/m;->d:Ljava/util/List;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p1, p0, Lm0/m;->e:Lr0/h;
...
.method public final b(Landroid/graphics/Path$Op;)V
    ...
    iget-object v0, p0, Lm0/m;->b:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lm0/m;->a:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    iget-object v2, p0, Lm0/m;->d:Ljava/util/List;
    ...
    invoke-virtual {v5}, Lm0/e;->d()Ljava/util/List;
    ...
    invoke-interface {v8}, Lm0/n;->g()Landroid/graphics/Path;

    move-result-object v8

    iget-object v9, v5, Lm0/e;->k:Ln0/w;

    if-eqz v9, :cond_0

    invoke-virtual {v9}, Ln0/w;->d()Landroid/graphics/Matrix;
    ...
    :cond_0
    iget-object v9, v5, Lm0/e;->c:Landroid/graphics/Matrix;
    ...
    iget-object v6, v2, Lm0/e;->k:Ln0/w;

    if-eqz v6, :cond_4

    invoke-virtual {v6}, Ln0/w;->d()Landroid/graphics/Matrix;
    ...
    :cond_4
    iget-object v6, v2, Lm0/e;->c:Landroid/graphics/Matrix;
    ...
    :cond_6
    iget-object p0, p0, Lm0/m;->c:Landroid/graphics/Path;
...
.method public final c(Ljava/util/List;Ljava/util/List;)V
    ...
    :goto_0
    iget-object v1, p0, Lm0/m;->d:Ljava/util/List;
    ...
    invoke-interface {v1, p1, p2}, Lm0/d;->c(Ljava/util/List;Ljava/util/List;)V
...
.method public final g()Landroid/graphics/Path;
    ...
    iget-object v0, p0, Lm0/m;->c:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lm0/m;->e:Lr0/h;

    iget-boolean v2, v1, Lr0/h;->b:Z
    ...
    :cond_0
    iget-object v1, v1, Lr0/h;->a:Lcom/airbnb/lottie/model/content/MergePaths$MergePathsMode;
    ...
    invoke-virtual {p0, v1}, Lm0/m;->b(Landroid/graphics/Path$Op;)V
