...
.method public constructor <init>(Lv/f;)V
    ...
    sget-object v0, Landroidx/constraintlayout/core/widgets/analyzer/DependencyNode$Type;->g:Landroidx/constraintlayout/core/widgets/analyzer/DependencyNode$Type;
...
.method public final a(Lw/e;)V
    ...
    :cond_2
    iget-object v3, v4, Lv/f;->e:Landroidx/constraintlayout/core/widgets/analyzer/e;
    ...
    iget-object v12, v4, Lv/f;->K:Lv/d;
    ...
    :goto_4
    iget-object v13, v4, Lv/f;->L:Lv/d;

    iget-object v13, v13, Lv/d;->f:Lv/d;
    ...
    :goto_5
    iget-object v14, v4, Lv/f;->M:Lv/d;
    ...
    :goto_6
    iget-object v15, v4, Lv/f;->N:Lv/d;

    iget-object v15, v15, Lv/d;->f:Lv/d;
    ...
    :cond_a
    iget-object v5, v6, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v5, v7, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v13, v10, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v11, v3, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v11, v0, Landroidx/constraintlayout/core/widgets/analyzer/f;->b:Lv/f;

    iget-object v11, v11, Lv/f;->e:Landroidx/constraintlayout/core/widgets/analyzer/e;
    ...
    :cond_10
    iget-object v11, v6, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v11, v7, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v10, v3, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v4, v6, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v10, v7, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v12, v10, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    :cond_20
    iget-object v3, v4, Lv/f;->W:Lv/f;

    if-eqz v3, :cond_21

    iget-object v3, v3, Lv/f;->d:Landroidx/constraintlayout/core/widgets/analyzer/d;
    ...
    iget-object v8, v7, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget v10, v3, Lv/f;->s:I

    if-nez v10, :cond_24

    invoke-virtual {v3}, Lv/f;->y()Z
    ...
    iget v9, v6, Landroidx/constraintlayout/core/widgets/analyzer/a;->f:I
    ...
    iget-object v3, v1, Lv/f;->K:Lv/d;

    iget-object v1, v1, Lv/f;->M:Lv/d;

    invoke-virtual {v0, v3, v1, v2}, Landroidx/constraintlayout/core/widgets/analyzer/f;->l(Lv/d;Lv/d;I)V
...
.method public final d()V
    ...
    iget-object v8, v0, Lv/f;->V:[Landroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;
    ...
    iget-object v9, v0, Lv/f;->W:Lv/f;

    if-eqz v9, :cond_2

    iget-object v10, v9, Lv/f;->V:[Landroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;
    ...
    :cond_1
    invoke-virtual {v9}, Lv/f;->r()I

    move-result v0

    iget-object v1, p0, Landroidx/constraintlayout/core/widgets/analyzer/f;->b:Lv/f;

    iget-object v1, v1, Lv/f;->K:Lv/d;
    ...
    iget-object v1, v9, Lv/f;->d:Landroidx/constraintlayout/core/widgets/analyzer/d;
    ...
    iget-object v3, p0, Landroidx/constraintlayout/core/widgets/analyzer/f;->b:Lv/f;

    iget-object v3, v3, Lv/f;->K:Lv/d;
    ...
    iget-object v8, v0, Lv/f;->W:Lv/f;

    if-eqz v8, :cond_5

    iget-object v9, v8, Lv/f;->V:[Landroidx/constraintlayout/core/widgets/ConstraintWidget$DimensionBehaviour;
    ...
    :cond_4
    iget-object v1, v8, Lv/f;->d:Landroidx/constraintlayout/core/widgets/analyzer/d;
    ...
    iget-object v0, v8, Lv/f;->d:Landroidx/constraintlayout/core/widgets/analyzer/d;
    ...
    iget-object v8, v4, Lv/d;->f:Lv/d;

    if-eqz v8, :cond_9

    aget-object v9, v1, v3

    iget-object v9, v9, Lv/d;->f:Lv/d;

    if-eqz v9, :cond_9

    invoke-virtual {v0}, Lv/f;->y()Z
    ...
    invoke-static {v0}, Landroidx/constraintlayout/core/widgets/analyzer/f;->h(Lv/d;)Landroidx/constraintlayout/core/widgets/analyzer/a;
    ...
    invoke-static {v6, v0, v1}, Landroidx/constraintlayout/core/widgets/analyzer/f;->b(Landroidx/constraintlayout/core/widgets/analyzer/a;Landroidx/constraintlayout/core/widgets/analyzer/a;I)V
    ...
    :cond_8
    iput-boolean v3, v6, Landroidx/constraintlayout/core/widgets/analyzer/a;->b:Z

    iput-boolean v3, v5, Landroidx/constraintlayout/core/widgets/analyzer/a;->b:Z
    ...
    invoke-virtual {v0, v1}, Lv/f;->j(Landroidx/constraintlayout/core/widgets/ConstraintAnchor$Type;)Lv/d;
    ...
    iget-object v8, v2, Landroidx/constraintlayout/core/widgets/analyzer/a;->k:Ljava/util/List;

    iget-object v9, v2, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iget-object v1, v0, Lv/f;->e:Landroidx/constraintlayout/core/widgets/analyzer/e;

    iget-object v4, v1, Landroidx/constraintlayout/core/widgets/analyzer/f;->h:Landroidx/constraintlayout/core/widgets/analyzer/a;
    ...
    iget-object v0, v0, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    iput-boolean v3, v2, Landroidx/constraintlayout/core/widgets/analyzer/a;->b:Z
    ...
    iget-object v0, v6, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;

    check-cast v0, Ljava/util/ArrayList;

    invoke-virtual {v0, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v5, Landroidx/constraintlayout/core/widgets/analyzer/a;->l:Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, Landroidx/constraintlayout/core/widgets/analyzer/a;->b(Lw/e;)V

    :cond_15
    if-eqz v1, :cond_16

    invoke-virtual {v1, p0}, Landroidx/constraintlayout/core/widgets/analyzer/a;->b(Lw/e;)V
    ...
    invoke-virtual {p0, v5, v6, v3, v2}, Landroidx/constraintlayout/core/widgets/analyzer/f;->c(Landroidx/constraintlayout/core/widgets/analyzer/a;Landroidx/constraintlayout/core/widgets/analyzer/a;ILandroidx/constraintlayout/core/widgets/analyzer/b;)V
