...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3}, Lk/b;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 11
    invoke-static {p0, p1}, Landroidx/core/view/x;->m(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final g(Li/b;)V
    ...
    invoke-direct {v2, p1}, Lk/d;-><init>(Li/b;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Li/b;->e()Lj/o;

    move-result-object p1

    iget-object v0, p0, Lk/b;->g:Lk/n;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lk/n;->e()Z

    iget-object v0, v0, Lk/n;->u:Lk/i;
    ...
    iput-object v0, p0, Lk/b;->g:Lk/n;

    const/4 v2, 0x1

    iput-boolean v2, v0, Lk/n;->m:Z

    iput-boolean v2, v0, Lk/n;->n:Z
    ...
    iget-object v2, p0, Lk/b;->g:Lk/n;

    iget-object v3, p0, Lk/b;->e:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Lj/o;->b(Lj/C;Landroid/content/Context;)V

    iget-object p1, p0, Lk/b;->g:Lk/n;

    iget-object v2, p1, Lk/n;->k:Lj/E;

    if-nez v2, :cond_3

    iget-object v3, p1, Lk/n;->g:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lk/n;->k:Lj/E;

    iget-object v3, p1, Lk/n;->f:Lj/o;

    invoke-interface {v1, v3}, Lj/E;->a(Lj/o;)V

    invoke-virtual {p1}, Lk/n;->d()V

    :cond_3
    iget-object v1, p1, Lk/n;->k:Lj/E;
    ...
    iput-object p1, v2, Landroidx/appcompat/widget/ActionMenuView;->w:Lk/n;

    iput-object v2, p1, Lk/n;->k:Lj/E;

    iget-object p1, p1, Lk/n;->f:Lj/o;

    iput-object p1, v2, Landroidx/appcompat/widget/ActionMenuView;->s:Lj/o;

    :cond_4
    check-cast v1, Landroidx/appcompat/widget/ActionMenuView;

    iput-object v1, p0, Lk/b;->f:Landroidx/appcompat/widget/ActionMenuView;

    sget-object p1, Landroidx/core/view/J;->a:Ljava/util/WeakHashMap;

    const/4 p1, 0x0

    invoke-static {v1, p1}, Landroidx/core/view/x;->m(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Lk/b;->f:Landroidx/appcompat/widget/ActionMenuView;
...
.method public final i()V
    ...
    iput-object v0, p0, Lk/b;->f:Landroidx/appcompat/widget/ActionMenuView;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {v0, v1, p5, v3, p1}, Lk/b;->d(IIILandroid/view/View;Z)I
    ...
    invoke-static {v0, v1, p5, p3, p1}, Lk/b;->d(IIILandroid/view/View;Z)I
    ...
    :goto_5
    iget-object p0, p0, Lk/b;->f:Landroidx/appcompat/widget/ActionMenuView;

    if-eqz p0, :cond_9

    xor-int/lit8 p1, p1, 0x1

    invoke-static {p2, v1, p5, p0, p1}, Lk/b;->d(IIILandroid/view/View;Z)I
...
.method public final onMeasure(II)V
    ...
    invoke-static {v6, p2, v5}, Lk/b;->c(Landroid/view/View;II)I
    ...
    :cond_1
    iget-object v6, p0, Lk/b;->f:Landroidx/appcompat/widget/ActionMenuView;
