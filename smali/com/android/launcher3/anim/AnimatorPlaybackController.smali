.class public final Lcom/android/launcher3/anim/AnimatorPlaybackController;
...
.method public constructor <init>(Landroid/animation/AnimatorSet;JLjava/util/ArrayList;)V
    ...
    invoke-direct {p3, p0}, Lcom/android/launcher3/anim/AnimatorPlaybackController$OnAnimationEndDispatcher;-><init>(Lcom/android/launcher3/anim/AnimatorPlaybackController;)V
...
.method public static a(Landroid/animation/Animator;Ljava/util/function/BiConsumer;)V
    .locals 2
...
.method public static synthetic b(Lcom/android/launcher3/anim/AnimatorPlaybackController;FF)F
    .locals 6
...
.method public static bridge synthetic c(Lcom/android/launcher3/anim/AnimatorPlaybackController;)Ljava/lang/Runnable;
    .locals 0
...
.method private static callAnimatorCommandRecursively(Landroid/animation/Animator;Lcom/android/launcher3/anim/d;)V
    .locals 1

    invoke-virtual {p1, p0}, Lcom/android/launcher3/anim/d;->accept(Ljava/lang/Object;)V
    ...
    invoke-static {v0, p1}, Lcom/android/launcher3/anim/AnimatorPlaybackController;->callAnimatorCommandRecursively(Landroid/animation/Animator;Lcom/android/launcher3/anim/d;)V
...
.method public static callListenerCommandRecursively(Landroid/animation/Animator;Ljava/util/function/BiConsumer;)V
    ...
    invoke-direct {v0, v1, p1}, Lcom/android/launcher3/anim/d;-><init>(ILjava/lang/Object;)V

    invoke-static {p0, v0}, Lcom/android/launcher3/anim/AnimatorPlaybackController;->callAnimatorCommandRecursively(Landroid/animation/Animator;Lcom/android/launcher3/anim/d;)V
...
.method public final dispatchOnCancel()V
    ...
    invoke-direct {v0, v1}, Lcom/android/launcher3/anim/c;-><init>(I)V

    invoke-static {p0, v0}, Lcom/android/launcher3/anim/AnimatorPlaybackController;->callListenerCommandRecursively(Landroid/animation/Animator;Ljava/util/function/BiConsumer;)V

    return-void
.end method

.method public final dispatchOnEnd()V
    .locals 2
...
.method public final dispatchSetInterpolator(Lcom/android/quickstep/p;)V
    .locals 2
...
.method public final forceFinishIfCloseToEnd()V
    .locals 2
...
.method public final getAnimationPlayer()Landroid/animation/ValueAnimator;
    .locals 0
...
.method public final getInterpolatedProgress()F
    .locals 1
...
.method public final pause()V
    ...
    iget-object v4, v3, Lcom/android/launcher3/anim/AnimatorPlaybackController$Holder;->anim:Landroid/animation/ValueAnimator;

    iget-object v5, v3, Lcom/android/launcher3/anim/AnimatorPlaybackController$Holder;->interpolator:Landroid/animation/TimeInterpolator;

    invoke-virtual {v4, v5}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    sget-object v4, Lcom/android/launcher3/anim/AnimatorPlaybackController$ProgressMapper;->DEFAULT:Lcom/android/launcher3/anim/g;

    iput-object v4, v3, Lcom/android/launcher3/anim/AnimatorPlaybackController$Holder;->mapper:Lcom/android/launcher3/anim/AnimatorPlaybackController$ProgressMapper;
...
.method public final reverse()V
    ...
    iget v3, p0, Lcom/android/launcher3/anim/AnimatorPlaybackController;->mCurrentFraction:F
    ...
    iget-wide v4, p0, Lcom/android/launcher3/anim/AnimatorPlaybackController;->mDuration:J
...
.method public final setEndAction(Ljava/lang/Runnable;)V
    .locals 0
...
.method public final setPlayFraction(F)V
    ...
    iget-object v3, v2, Lcom/android/launcher3/anim/AnimatorPlaybackController$Holder;->mapper:Lcom/android/launcher3/anim/AnimatorPlaybackController$ProgressMapper;

    iget v4, v2, Lcom/android/launcher3/anim/AnimatorPlaybackController$Holder;->globalEndProgress:F

    invoke-interface {v3, p1, v4}, Lcom/android/launcher3/anim/AnimatorPlaybackController$ProgressMapper;->getProgress(FF)F

    move-result v3

    iget-object v2, v2, Lcom/android/launcher3/anim/AnimatorPlaybackController$Holder;->anim:Landroid/animation/ValueAnimator;
...
.method public final start()V
    ...
    iget-wide v1, p0, Lcom/android/launcher3/anim/AnimatorPlaybackController;->mDuration:J
...
.method public final startWithVelocity(Lcom/android/launcher3/BaseDraggingActivity;ZFFJ)V
    .locals 19
    ...
    iget v7, v0, Lcom/android/launcher3/anim/AnimatorPlaybackController;->mCurrentFraction:F
    ...
    invoke-virtual {v10, v11}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setStartValue(F)V
    ...
    :goto_2
    invoke-virtual {v10, v11}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setEndValue(F)V

    invoke-virtual {v10, v5}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setStartVelocity(F)V

    invoke-virtual {v10, v3}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setMinimumVisibleChange(F)V
    ...
    iget v3, v11, Lcom/android/launcher3/anim/SpringProperty;->mDampingRatio:F

    invoke-virtual {v10, v3}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setDampingRatio(F)V

    iget v3, v11, Lcom/android/launcher3/anim/SpringProperty;->mStiffness:F

    invoke-virtual {v10, v3}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setStiffness(F)V

    invoke-virtual {v10}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->computeParams()V
    ...
    new-instance v11, Lcom/android/launcher3/anim/f;

    invoke-direct {v11, v10}, Lcom/android/launcher3/anim/f;-><init>(Lcom/android/launcher3/anim/SpringAnimationBuilder;)V
    ...
    invoke-static/range {p3 .. p3}, Ly0/e;->c(F)Ly0/d;
    ...
    invoke-static {v4, v1, v3}, Ly0/e;->b(FFLandroid/view/animation/Interpolator;)Ly0/b;
