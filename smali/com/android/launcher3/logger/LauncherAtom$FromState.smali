...
.method public static constructor <clinit>()V
    ...
    const-string v2, "FROM_EMPTY"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lcom/android/launcher3/logger/LauncherAtom$FromState;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v2, Lcom/android/launcher3/logger/LauncherAtom$FromState;

    const-string v3, "FROM_CUSTOM"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/android/launcher3/logger/LauncherAtom$FromState;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/android/launcher3/logger/LauncherAtom$FromState;->FROM_CUSTOM:Lcom/android/launcher3/logger/LauncherAtom$FromState;

    new-instance v3, Lcom/android/launcher3/logger/LauncherAtom$FromState;

    const-string v4, "FROM_SUGGESTED"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lcom/android/launcher3/logger/LauncherAtom$FromState;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/android/launcher3/logger/LauncherAtom$FromState;->FROM_SUGGESTED:Lcom/android/launcher3/logger/LauncherAtom$FromState;
