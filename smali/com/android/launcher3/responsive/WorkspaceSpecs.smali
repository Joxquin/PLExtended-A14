.class public final Lcom/android/launcher3/responsive/WorkspaceSpecs;
...
.method public static final create(Lcom/android/launcher3/util/ResourceHelper;)Lcom/android/launcher3/responsive/WorkspaceSpecs;
    .locals 5
    ...
    const-string p0, "workspaceSpec"

    sget-object v1, Lcom/android/launcher3/responsive/WorkspaceSpecs$Companion$create$specs$1;->INSTANCE:Lcom/android/launcher3/responsive/WorkspaceSpecs$Companion$create$specs$1;
    ...
    check-cast v3, Lcom/android/launcher3/responsive/WorkspaceSpec;

    invoke-virtual {v3}, Lcom/android/launcher3/responsive/WorkspaceSpec;->getSpecType()Lcom/android/launcher3/responsive/ResponsiveSpec$SpecType;
    ...
    new-instance v1, Lcom/android/launcher3/responsive/WorkspaceSpecs;

    invoke-direct {v1, v0, p0}, Lcom/android/launcher3/responsive/WorkspaceSpecs;-><init>(Ljava/util/List;Ljava/util/List;)V
