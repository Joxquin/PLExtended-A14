...
.method public constructor <init>(Lcom/android/quickstep/FallbackSwipeHandler;J)V
    ...
    invoke-static {p1}, Lcom/android/quickstep/FallbackSwipeHandler;->t0(Lcom/android/quickstep/FallbackSwipeHandler;)Z
    ...
    invoke-static {v0, v3, v5}, Lcom/android/launcher3/Utilities;->boundToRange(FFF)F

    move-result v0

    iput v0, p2, Lcom/android/launcher3/anim/AnimatedFloat;->value:F
    ...
    invoke-direct {p2, v4, p0}, Lcom/android/quickstep/F;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v1, p0, v4}, Lcom/android/quickstep/G;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;I)V

    invoke-direct {p2, v1}, Lcom/android/launcher3/anim/AnimatedFloat;-><init>(Ljava/lang/Runnable;)V

    iput-object p2, p0, Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;->mHomeAlpha:Lcom/android/launcher3/anim/AnimatedFloat;

    iput v3, p2, Lcom/android/launcher3/anim/AnimatedFloat;->value:F

    new-instance p2, Lcom/android/quickstep/E;

    invoke-direct {p2, p3, p0}, Lcom/android/quickstep/E;-><init>(ILjava/lang/Object;)V
    ...
    :goto_0
    iput v5, v2, Lcom/android/launcher3/anim/AnimatedFloat;->value:F

    new-instance p2, Lcom/android/quickstep/F;

    invoke-direct {p2, p3, p0}, Lcom/android/quickstep/F;-><init>(ILjava/lang/Object;)V
...
.method private addGestureContract(Landroid/content/Intent;Landroid/app/ActivityManager$RunningTaskInfo;)V
    ...
    invoke-static {v0}, Lcom/android/quickstep/FallbackSwipeHandler;->t0(Lcom/android/quickstep/FallbackSwipeHandler;)Z
    ...
    invoke-static {}, Lcom/android/quickstep/FallbackSwipeHandler;->v0()Lcom/android/quickstep/FallbackSwipeHandler$StaticMessageReceiver;
    ...
    invoke-direct {p2, v1}, Lcom/android/quickstep/FallbackSwipeHandler$StaticMessageReceiver;-><init>(I)V

    invoke-static {p2}, Lcom/android/quickstep/FallbackSwipeHandler;->w0(Lcom/android/quickstep/FallbackSwipeHandler$StaticMessageReceiver;)V
...
.method public static synthetic d(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;)V
    .locals 0
...
.method public static bridge synthetic g(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;Landroid/content/Intent;Landroid/app/ActivityManager$RunningTaskInfo;)V
    .locals 0
...
.method private updateHomeActivityTransformDuringHomeAnim(Lcom/android/quickstep/util/SurfaceTransaction$SurfaceProperties;Landroid/view/RemoteAnimationTarget;Lcom/android/quickstep/util/TransformParams;)V
    ...
    invoke-static {p3, p1, p2, v0, p0}, Lcom/android/quickstep/FallbackSwipeHandler;->u0(Lcom/android/quickstep/FallbackSwipeHandler;Lcom/android/quickstep/util/SurfaceTransaction$SurfaceProperties;Landroid/view/RemoteAnimationTarget;FF)V
...
.method public createActivityAnimationToHome()Lcom/android/launcher3/anim/AnimatorPlaybackController;
    ...
    sget-object v2, Ly0/e;->u:Landroid/view/animation/Interpolator;
...
.method public playAtomicAnimation(F)V
    ...
    sget-object v3, Ly0/e;->u:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v0, v1}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setStartValue(F)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setEndValue(F)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setStartVelocity(F)V

    iget-object p1, p0, Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;->this$0:Lcom/android/quickstep/FallbackSwipeHandler;
    ...
    invoke-virtual {v0, v2}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setMinimumVisibleChange(F)V

    const p1, 0x3f19999a    # 0.6f

    invoke-virtual {v0, p1}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setDampingRatio(F)V

    const/high16 p1, 0x44480000    # 800.0f

    invoke-virtual {v0, p1}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->setStiffness(F)V
    ...
    sget-object p1, Lcom/android/launcher3/anim/AnimatedFloat;->VALUE:Landroid/util/FloatProperty;

    invoke-virtual {v0, p0, p1}, Lcom/android/launcher3/anim/SpringAnimationBuilder;->build(Ljava/lang/Object;Landroid/util/FloatProperty;)Landroid/animation/ValueAnimator;
...
.method public setAnimation(Lcom/android/quickstep/util/RectFSpringAnim;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/quickstep/G;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;I)V
...
.method public update(Landroid/graphics/RectF;FF)V
    ...
    invoke-virtual {p1, p2, v0, p0, p3}, Landroid/view/SurfaceControl$Transaction;->setGeometry(Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;I)Landroid/view/SurfaceControl$Transaction;
