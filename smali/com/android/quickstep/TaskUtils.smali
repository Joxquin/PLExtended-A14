...
.method public static synthetic b(Landroid/content/Context;Lcom/android/systemui/shared/recents/model/Task;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0, p1}, Lcom/android/quickstep/TaskUtils;->lambda$getTitle$0(Landroid/content/Context;Lcom/android/systemui/shared/recents/model/Task;)Ljava/lang/CharSequence;
...
.method public static closeSystemWindowsAsync(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/quickstep/x1;-><init>(Ljava/lang/String;)V
...
.method public static getTitle(Landroid/content/Context;Lcom/android/systemui/shared/recents/model/Task;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/quickstep/w1;-><init>(Landroid/content/Context;Lcom/android/systemui/shared/recents/model/Task;)V

    const-string p0, "TaskUtils.getTitle"

    invoke-static {p0, v0}, Lcom/android/launcher3/util/TraceHelper;->allowIpcs(Ljava/lang/String;Ljava/util/function/Supplier;)Ljava/lang/Object;
...
.method public static getTitle(Landroid/content/Context;Ljava/lang/Integer;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    .line 4
    invoke-virtual {v3, v4, v2, p2}, Lcom/android/launcher3/util/PackageManagerHelper;->getApplicationInfo(ILandroid/os/UserHandle;Ljava/lang/String;)Landroid/content/pm/ApplicationInfo;
...
.method private static synthetic lambda$getTitle$0(Landroid/content/Context;Lcom/android/systemui/shared/recents/model/Task;)Ljava/lang/CharSequence;
    .locals 1
    ...
    invoke-static {p0, v0, p1}, Lcom/android/quickstep/TaskUtils;->getTitle(Landroid/content/Context;Ljava/lang/Integer;Ljava/lang/String;)Ljava/lang/CharSequence;
