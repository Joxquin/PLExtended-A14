...
.field private static final CURRENT_ANGLE:Landroidx/dynamicanimation/animation/q;

.field private static final CURRENT_TRANSLATION:Landroidx/dynamicanimation/animation/q;

.field private static final CURRENT_VERTICAL_TRANSLATION:Landroidx/dynamicanimation/animation/q;
...
# instance fields
.field private final mAngleAnimation:Landroidx/dynamicanimation/animation/s;

.field private final mAngleAppearForce:Landroidx/dynamicanimation/animation/t;

.field private final mAngleDisappearForce:Landroidx/dynamicanimation/animation/t;
...
.field private final mRegularTranslationSpring:Landroidx/dynamicanimation/animation/t;

.field private mScreenSize:I

.field private final mSetGoneEndListener:Landroidx/dynamicanimation/animation/j;
...
.field private final mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

.field private mTriggerBack:Z

.field private final mTriggerBackSpring:Landroidx/dynamicanimation/animation/t;

.field private mVelocityTracker:Landroid/view/VelocityTracker;

.field private mVerticalTranslation:F

.field private final mVerticalTranslationAnimation:Landroidx/dynamicanimation/animation/s;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_ANGLE:Landroidx/dynamicanimation/animation/q;
    ...
    sput-object v0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_TRANSLATION:Landroidx/dynamicanimation/animation/q;
    ...
    sput-object v0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_VERTICAL_TRANSLATION:Landroidx/dynamicanimation/animation/q;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mSetGoneEndListener:Landroidx/dynamicanimation/animation/j;
    ...
    new-instance v1, Landroidx/dynamicanimation/animation/s;

    sget-object v2, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_ANGLE:Landroidx/dynamicanimation/animation/q;

    invoke-direct {v1, v2, p0}, Landroidx/dynamicanimation/animation/s;-><init>(Landroidx/dynamicanimation/animation/q;Ljava/lang/Object;)V

    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAnimation:Landroidx/dynamicanimation/animation/s;

    new-instance v2, Landroidx/dynamicanimation/animation/t;

    invoke-direct {v2}, Landroidx/dynamicanimation/animation/t;-><init>()V

    const/high16 v3, 0x43fa0000    # 500.0f

    invoke-virtual {v2, v3}, Landroidx/dynamicanimation/animation/t;->b(F)V

    const/high16 v3, 0x3f000000    # 0.5f

    invoke-virtual {v2, v3}, Landroidx/dynamicanimation/animation/t;->a(F)V

    iput-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAppearForce:Landroidx/dynamicanimation/animation/t;

    new-instance v4, Landroidx/dynamicanimation/animation/t;

    invoke-direct {v4}, Landroidx/dynamicanimation/animation/t;-><init>()V

    const v5, 0x44bb8000    # 1500.0f

    invoke-virtual {v4, v5}, Landroidx/dynamicanimation/animation/t;->b(F)V

    invoke-virtual {v4, v3}, Landroidx/dynamicanimation/animation/t;->a(F)V

    const/high16 v3, 0x42b40000    # 90.0f

    float-to-double v6, v3

    iput-wide v6, v4, Landroidx/dynamicanimation/animation/t;->i:D

    iput-object v4, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleDisappearForce:Landroidx/dynamicanimation/animation/t;

    iput-object v2, v1, Landroidx/dynamicanimation/animation/s;->x:Landroidx/dynamicanimation/animation/t;

    iput v3, v1, Landroidx/dynamicanimation/animation/m;->g:F

    new-instance v1, Landroidx/dynamicanimation/animation/s;

    sget-object v2, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_TRANSLATION:Landroidx/dynamicanimation/animation/q;

    invoke-direct {v1, v2, p0}, Landroidx/dynamicanimation/animation/s;-><init>(Landroidx/dynamicanimation/animation/q;Ljava/lang/Object;)V

    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    new-instance v2, Landroidx/dynamicanimation/animation/t;

    invoke-direct {v2}, Landroidx/dynamicanimation/animation/t;-><init>()V

    invoke-virtual {v2, v5}, Landroidx/dynamicanimation/animation/t;->b(F)V

    const/high16 v3, 0x3f400000    # 0.75f

    invoke-virtual {v2, v3}, Landroidx/dynamicanimation/animation/t;->a(F)V

    iput-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mRegularTranslationSpring:Landroidx/dynamicanimation/animation/t;
    ...
    invoke-virtual {v4, v6}, Landroidx/dynamicanimation/animation/t;->b(F)V

    invoke-virtual {v4, v3}, Landroidx/dynamicanimation/animation/t;->a(F)V

    iput-object v4, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTriggerBackSpring:Landroidx/dynamicanimation/animation/t;

    iput-object v2, v1, Landroidx/dynamicanimation/animation/s;->x:Landroidx/dynamicanimation/animation/t;

    new-instance v1, Landroidx/dynamicanimation/animation/s;

    sget-object v2, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_VERTICAL_TRANSLATION:Landroidx/dynamicanimation/animation/q;

    invoke-direct {v1, v2, p0}, Landroidx/dynamicanimation/animation/s;-><init>(Landroidx/dynamicanimation/animation/q;Ljava/lang/Object;)V

    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVerticalTranslationAnimation:Landroidx/dynamicanimation/animation/s;
    ...
    invoke-static {v0, p1, v1}, Lcom/android/launcher3/testing/shared/ResourceUtils;->getDimenByName(ILandroid/content/res/Resources;Ljava/lang/String;)I
...
.method public static synthetic c(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method private cancelBack()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    iget-boolean v1, v0, Landroidx/dynamicanimation/animation/m;->f:Z

    if-eqz v1, :cond_1

    iget-object p0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mSetGoneEndListener:Landroidx/dynamicanimation/animation/j;

    invoke-virtual {v0, p0}, Landroidx/dynamicanimation/animation/m;->a(Landroidx/dynamicanimation/animation/j;)V
...
.method public static bridge synthetic d(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;)F
    .locals 0
...
.method public static bridge synthetic e(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;)F
    .locals 0
...
.method public static bridge synthetic f(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;)F
    .locals 0
...
.method public static bridge synthetic g(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;F)V
    .locals 0
...
.method public static bridge synthetic h(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;F)V
    .locals 0
...
.method private handleMoveEvent(Landroid/view/MotionEvent;)V
    ...
    iput-boolean v3, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mDragSlopPassed:Z
    ...
    sget-object v5, Lcom/android/launcher3/util/VibratorWrapper;->EFFECT_CLICK:Landroid/os/VibrationEffect;

    invoke-virtual {v2, v5}, Lcom/android/launcher3/util/VibratorWrapper;->vibrate(Landroid/os/VibrationEffect;)V

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v5

    iput-wide v5, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVibrationTime:J
    ...
    invoke-direct {p0, v3, v3}, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->setTriggerBack(ZZ)V
    ...
    iget v5, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mScreenSize:I
    ...
    iget v5, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mBaseTranslation:F

    invoke-static {v2, v5, v1, v5}, Lw/f;->a(FFFF)F
    ...
    iget v7, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mMinDeltaForSwitch:F
    ...
    :cond_5
    :goto_2
    iget-object v5, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iget-object v8, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput v5, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleOffset:F

    iget-boolean v6, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mIsLeftPanel:Z

    if-eqz v6, :cond_6

    iget-boolean v8, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mArrowsPointLeft:Z
    ...
    iget-boolean v6, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mArrowsPointLeft:Z
    ...
    iget v6, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mStartX:F
    ...
    :goto_3
    invoke-direct {p0, v7, v3}, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->setTriggerBack(ZZ)V
    ...
    :goto_4
    invoke-direct {p0, v4, v3}, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->setDesiredTranslation(FZ)V

    invoke-direct {p0, v3}, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->updateAngle(Z)V
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->setDesiredVerticalTransition(FZ)V

    return-void
.end method

.method public static bridge synthetic i(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;F)V
    .locals 0
...
.method private lambda$triggerBack$2()V
    .locals 4
    ...
    iget-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    iget-object v3, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTriggerBackSpring:Landroidx/dynamicanimation/animation/t;

    iput-object v3, v2, Landroidx/dynamicanimation/animation/s;->x:Landroidx/dynamicanimation/animation/t;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/quickstep/interaction/h;-><init>(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;I)V
...
.method private loadDimens()V
    ...
    invoke-static {v2, v0, v1}, Lcom/android/launcher3/testing/shared/ResourceUtils;->getDimenByName(ILandroid/content/res/Resources;Ljava/lang/String;)I
...
.method private resetOnDown()V
    ...
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAnimation:Landroidx/dynamicanimation/animation/s;
    ...
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVerticalTranslationAnimation:Landroidx/dynamicanimation/animation/s;
    ...
    iget-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    iget-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mRegularTranslationSpring:Landroidx/dynamicanimation/animation/t;
...
.method private setDesiredTranslation(FZ)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;
...
.method private setDesiredVerticalTransition(FZ)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVerticalTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    invoke-virtual {p2, p1}, Landroidx/dynamicanimation/animation/s;->j(F)V
...
.method private setTriggerBack(ZZ)V
    ...
    iget-object p1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAnimation:Landroidx/dynamicanimation/animation/s;

    invoke-virtual {p1}, Landroidx/dynamicanimation/animation/s;->b()V

    invoke-direct {p0, p2}, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->updateAngle(Z)V

    iget-object p0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    invoke-virtual {p0}, Landroidx/dynamicanimation/animation/s;->b()V
...
.method private triggerBack()V
    ...
    :cond_5
    new-instance v0, Lcom/android/quickstep/interaction/h;

    invoke-direct {v0, p0, v1}, Lcom/android/quickstep/interaction/h;-><init>(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;I)V

    iget-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:Landroidx/dynamicanimation/animation/s;

    iget-boolean v2, v1, Landroidx/dynamicanimation/animation/m;->f:Z
    ...
    invoke-virtual {v1, v2}, Landroidx/dynamicanimation/animation/m;->a(Landroidx/dynamicanimation/animation/j;)V

    goto :goto_1

    :cond_6
    invoke-virtual {v0}, Lcom/android/quickstep/interaction/h;->run()V
...
.method private updateAngle(Z)V
    ...
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAppearForce:Landroidx/dynamicanimation/animation/t;

    goto :goto_1

    :cond_2
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleDisappearForce:Landroidx/dynamicanimation/animation/t;

    :goto_1
    iput-object v0, p1, Landroidx/dynamicanimation/animation/s;->x:Landroidx/dynamicanimation/animation/t;

    invoke-virtual {p1, v2}, Landroidx/dynamicanimation/animation/s;->j(F)V
...
.method private updatePosition(F)V
    ...
    invoke-static {p1, v1, v0}, LH/a;->b(III)I
