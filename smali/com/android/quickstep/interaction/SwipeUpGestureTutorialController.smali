...
.method public constructor <init>(Lcom/android/quickstep/interaction/TutorialFragment;Lcom/android/quickstep/interaction/TutorialController$TutorialType;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/launcher3/DeviceProfile;->toBuilder(Landroid/content/Context;)Lcom/android/launcher3/DeviceProfile$Builder;
...
.method private createFingerDotSwipeUpAnimator(F)Landroid/animation/Animator;
    ...
    new-instance v1, Lcom/android/quickstep/interaction/r;

    invoke-direct {v1, p0, p1}, Lcom/android/quickstep/interaction/r;-><init>(Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;F)V
...
.method public static synthetic m(Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;FLandroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static bridge synthetic n(Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;)F
    .locals 0
...
.method public static bridge synthetic o(Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;)Landroid/graphics/Rect;
    .locals 0
...
.method public static bridge synthetic p(Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;)Landroid/animation/AnimatorListenerAdapter;
    .locals 0
...
.method public static bridge synthetic q(Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;F)V
    .locals 0
...
.method public animateFakeTaskViewHome(Landroid/graphics/PointF;Ljava/lang/Runnable;)V
    ...
    new-instance v0, Lcom/android/quickstep/interaction/q;

    invoke-direct {v0, p2}, Lcom/android/quickstep/interaction/q;-><init>(Landroid/animation/AnimatorSet;)V
...
.method public fadeOutFakeTaskView(ZLjava/lang/Runnable;)V
    .locals 6
...
.method public fadeOutFakeTaskView(ZZZLandroid/animation/ValueAnimator$AnimatorUpdateListener;Ljava/lang/Runnable;)V
    .locals 10
    ...
    .line 6
    invoke-virtual {v0, p1, v1, v3, v2}, Lcom/android/launcher3/anim/AnimatedPropertySetter;->setFloat(Ljava/lang/Object;Landroid/util/FloatProperty;FLandroid/animation/TimeInterpolator;)Landroid/animation/Animator;
    ...
    sget-object p4, Ly0/e;->u:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    .line 10
    invoke-virtual {v0, p1, p2, v1, p4}, Lcom/android/launcher3/anim/AnimatedPropertySetter;->setFloat(Ljava/lang/Object;Landroid/util/FloatProperty;FLandroid/animation/TimeInterpolator;)Landroid/animation/Animator;
...
.method public resetFakeTaskView(ZZ)V
    .locals 5
...
.method public resetFakeTaskViewFromOverview()V
    .locals 1
...
.method public resetTaskViews()V
    .locals 6
    ...
    invoke-virtual {v2}, Landroidx/fragment/app/K;->getActivity()Landroidx/fragment/app/P;
