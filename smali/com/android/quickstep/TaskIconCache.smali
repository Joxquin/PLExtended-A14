...
.method public static bridge synthetic d(Lcom/android/quickstep/TaskIconCache;Lcom/android/systemui/shared/recents/model/Task;)Lcom/android/quickstep/TaskIconCache$TaskCacheEntry;
    .locals 0
...
.method private getBitmapInfo(Landroid/graphics/drawable/Drawable;IIZ)Lcom/android/launcher3/icons/BitmapInfo;
    ...
    invoke-virtual {p3, p2}, Lcom/android/launcher3/icons/BaseIconFactory$IconOptions;->setUser(Landroid/os/UserHandle;)V

    invoke-virtual {p3, p4}, Lcom/android/launcher3/icons/BaseIconFactory$IconOptions;->setInstantApp(Z)V

    const/4 p2, 0x0

    invoke-virtual {p3, p2}, Lcom/android/launcher3/icons/BaseIconFactory$IconOptions;->setExtractedColor(I)V
...
.method private getCacheEntry(Lcom/android/systemui/shared/recents/model/Task;)Lcom/android/quickstep/TaskIconCache$TaskCacheEntry;
    ...
    invoke-direct {v2, v3}, Lcom/android/quickstep/TaskIconCache$TaskCacheEntry;-><init>(I)V

    iget v4, v1, Lcom/android/systemui/shared/recents/model/Task$TaskKey;->userId:I

    invoke-direct {p0, v0, v4}, Lcom/android/quickstep/TaskIconCache;->getIcon(Landroid/app/ActivityManager$TaskDescription;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v5, v4, v0, v3}, Lcom/android/quickstep/TaskIconCache;->getBitmapInfo(Landroid/graphics/drawable/Drawable;IIZ)Lcom/android/launcher3/icons/BitmapInfo;

    move-result-object v0

    iget-object v4, p0, Lcom/android/quickstep/TaskIconCache;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v3, v4}, Lcom/android/launcher3/icons/BitmapInfo;->newIcon(ILandroid/content/Context;)Lcom/android/launcher3/icons/FastBitmapDrawable;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/systemui/shared/system/PackageManagerWrapper;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v5, v4}, Lcom/android/launcher3/icons/IconProvider;->getIcon(Landroid/content/pm/ActivityInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5, v6, v0, v7}, Lcom/android/quickstep/TaskIconCache;->getBitmapInfo(Landroid/graphics/drawable/Drawable;IIZ)Lcom/android/launcher3/icons/BitmapInfo;

    move-result-object v0

    iget-object v5, p0, Lcom/android/quickstep/TaskIconCache;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v3, v5}, Lcom/android/launcher3/icons/BitmapInfo;->newIcon(ILandroid/content/Context;)Lcom/android/launcher3/icons/FastBitmapDrawable;
    ...
    iget-object v3, p1, Lcom/android/systemui/shared/recents/model/Task;->taskDescription:Landroid/app/ActivityManager$TaskDescription;

    invoke-direct {p0, v0, v1, v3}, Lcom/android/quickstep/TaskIconCache;->getBadgedContentDescription(Landroid/content/pm/ActivityInfo;ILandroid/app/ActivityManager$TaskDescription;)Ljava/lang/String;
...
.method private getDefaultIcon(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v2, p0}, Lcom/android/launcher3/icons/BitmapInfo;->newIcon(ILandroid/content/Context;)Lcom/android/launcher3/icons/FastBitmapDrawable;
    ...
    invoke-virtual {v4, v5}, Lcom/android/launcher3/icons/BaseIconFactory$IconOptions;->setUser(Landroid/os/UserHandle;)V
    ...
    invoke-virtual {v3, v2, p0}, Lcom/android/launcher3/icons/BitmapInfo;->newIcon(ILandroid/content/Context;)Lcom/android/launcher3/icons/FastBitmapDrawable;
...
.method private getIconFactory()Lcom/android/launcher3/icons/BaseIconFactory;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/launcher3/icons/BaseIconFactory;-><init>(Landroid/content/Context;IIZ)V
...
.method private synthetic lambda$invalidateCacheEntries$1(Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/quickstep/l1;-><init>(Ljava/lang/String;Landroid/os/UserHandle;)V
...
.method public clearCache()V
    ...
    invoke-direct {v1, p0}, Lcom/android/quickstep/k1;-><init>(Lcom/android/quickstep/TaskIconCache;)V
...
.method public dispatchIconUpdate(I)V
    .locals 0
...
.method public invalidateCacheEntries(Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/quickstep/m1;-><init>(Lcom/android/quickstep/TaskIconCache;Ljava/lang/String;Landroid/os/UserHandle;)V
...
.method public registerTaskVisualsChangeListener(Lcom/android/quickstep/util/TaskVisualsChangeListener;)V
    .locals 0
...
.method public removeTaskVisualsChangeListener()V
    .locals 1
