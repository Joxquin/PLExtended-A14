...
.field private final mSplitCancelConsumer:Ljava/util/function/Consumer;


# direct methods
.method public constructor <init>(Lcom/android/launcher3/Launcher;Ljava/lang/Runnable;Ljava/util/function/Consumer;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/quickstep/util/OverviewToHomeAnim;->mSplitCancelConsumer:Ljava/util/function/Consumer;

    return-void
.end method

.method public static bridge synthetic a(Lcom/android/quickstep/util/OverviewToHomeAnim;)V
    .locals 1

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/quickstep/util/OverviewToHomeAnim;->mIsHomeStaggeredAnimFinished:Z

    return-void
.end method

.method public static bridge synthetic b(Lcom/android/quickstep/util/OverviewToHomeAnim;)V
    .locals 1

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/quickstep/util/OverviewToHomeAnim;->mIsOverviewHidden:Z

    return-void
.end method

.method public static bridge synthetic c(Lcom/android/quickstep/util/OverviewToHomeAnim;)V
    .locals 0
...
.method public animateWithVelocity(F)V
    ...
    invoke-virtual {v0, v1, p1, v3}, Lcom/android/launcher3/statemanager/StateManager;->createAtomicAnimation(Lcom/android/launcher3/LauncherState;Lcom/android/launcher3/LauncherState;Lcom/android/launcher3/states/StateAnimationConfig;)Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, Lcom/android/quickstep/util/OverviewToHomeAnim;->mSplitCancelConsumer:Ljava/util/function/Consumer;
    ...
    invoke-virtual {v0, v2, p1}, Lcom/android/launcher3/statemanager/StateManager;->setCurrentAnimation(Landroid/animation/AnimatorSet;Lcom/android/launcher3/LauncherState;)V
