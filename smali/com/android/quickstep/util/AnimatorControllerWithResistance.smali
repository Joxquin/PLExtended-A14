...
.method public static createForRecents(Lcom/android/launcher3/anim/AnimatorPlaybackController;Landroid/content/Context;Lcom/android/quickstep/util/RecentsOrientedState;Lcom/android/launcher3/DeviceProfile;Ljava/lang/Object;Landroid/util/FloatProperty;Ljava/lang/Object;Landroid/util/FloatProperty;)Lcom/android/quickstep/util/AnimatorControllerWithResistance;
    ...
    sget-object v4, Lcom/android/launcher3/touch/AllAppsSwipeController;->ALL_APPS_SCRIM_RESPONDER:Ly0/b;

    const/4 v4, 0x1

    iput-boolean v4, v3, Lcom/android/launcher3/states/StateAnimationConfig;->userControlled:Z

    const/4 v5, 0x2

    iput v5, v3, Lcom/android/launcher3/states/StateAnimationConfig;->animFlags:I
    ...
    invoke-virtual {v3, v8, v2}, Lcom/android/launcher3/states/StateAnimationConfig;->setInterpolator(ILandroid/view/animation/Interpolator;)V

    sget-object v6, Lcom/android/launcher3/touch/AllAppsSwipeController;->ALL_APPS_SCRIM_RESPONDER:Ly0/b;

    const/16 v8, 0xb

    invoke-virtual {v3, v8, v6}, Lcom/android/launcher3/states/StateAnimationConfig;->setInterpolator(ILandroid/view/animation/Interpolator;)V

    sget-object v6, Ly0/e;->m:Landroid/view/animation/Interpolator;

    const v8, 0x3f4ccccd    # 0.8f

    invoke-static {v8, v7, v6}, Ly0/e;->b(FFLandroid/view/animation/Interpolator;)Ly0/b;
    ...
    invoke-virtual {v3, v4, v2}, Lcom/android/launcher3/states/StateAnimationConfig;->setInterpolator(ILandroid/view/animation/Interpolator;)V
    ...
    new-instance v6, Lcom/android/launcher3/touch/c;

    invoke-direct {v6, v2, v5}, Lcom/android/launcher3/touch/c;-><init>(FLandroid/view/animation/Interpolator;)V

    const/16 v9, 0x13

    invoke-virtual {v3, v9, v6}, Lcom/android/launcher3/states/StateAnimationConfig;->setInterpolator(ILandroid/view/animation/Interpolator;)V
    ...
    invoke-direct {v6, v5, v2, v7, v4}, Ly0/b;-><init>(Landroid/view/animation/Interpolator;FFI)V

    new-instance v4, Lcom/android/launcher3/touch/c;

    invoke-direct {v4, v2, v6}, Lcom/android/launcher3/touch/c;-><init>(FLandroid/view/animation/Interpolator;)V

    const/4 v2, 0x0

    invoke-virtual {v3, v2, v4}, Lcom/android/launcher3/states/StateAnimationConfig;->setInterpolator(ILandroid/view/animation/Interpolator;)V
...
.method public static createRecentsResistanceFromOverviewAnim(Lcom/android/launcher3/Launcher;Lcom/android/launcher3/anim/PendingAnimation;)Lcom/android/launcher3/anim/PendingAnimation;
    ...
    invoke-static {v10, p1}, Lcom/android/quickstep/util/AnimatorControllerWithResistance$RecentsParams;->a(Lcom/android/quickstep/util/AnimatorControllerWithResistance$RecentsParams;Lcom/android/launcher3/anim/PendingAnimation;)Lcom/android/quickstep/util/AnimatorControllerWithResistance$RecentsParams;
...
.method private static getAllAppsThreshold(Landroid/content/Context;Lcom/android/quickstep/util/RecentsOrientedState;Lcom/android/launcher3/DeviceProfile;)F
    ...
    sget-object p1, Lcom/android/launcher3/LauncherPrefs;->ALL_APPS_OVERVIEW_THRESHOLD:Lcom/android/launcher3/ConstantItem;

    invoke-virtual {p0, p1}, Lcom/android/launcher3/LauncherPrefs;->get(Lcom/android/launcher3/ConstantItem;)Ljava/lang/Object;
...
.method private static synthetic lambda$createRecentsResistanceAnim$0(FFFF)F
    ...
    invoke-static {p2, p0, p1, p0}, Lw/f;->a(FFFF)F
